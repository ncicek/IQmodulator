...
class high_frequency_if_stage(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "high_frequency_if_stage")
        ...
        self.analog_sig_source_x_0_0_1 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 100e3, 2, 0, 0)
        self.analog_sig_source_x_0_0_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 100e3, 2, 0, 0)
        self.analog_sig_source_x_0_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 10e3, 2, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 10e3, 2, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 1e3, 2, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0_0_1, 0), (self.blocks_multiply_xx_0_0, 1))
        ...
        self.connect((self.blocks_multiply_xx_0_1, 0), (self.qtgui_freq_sink_x_0_0, 0))
        self.connect((self.blocks_multiply_xx_0_1_0, 0), (self.blocks_add_xx_0, 1))
...
def main(top_block_cls=high_frequency_if_stage, options=None):

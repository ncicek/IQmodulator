...
/* Module Version: 1.2 */
/* C:\lscc\diamond\3.11_x64\ispfpga\bin\nt64\scuba.exe -w -n efb_inst -lang verilog -synth lse -bus_exp 7 -bb -type efb -arch xo3c00f -freq 50 -pll1 -wb -dev 6900  */
/* Wed Jan 13 20:48:14 2021 */


`timescale 1 ns / 1 ps
module efb_inst (wb_clk_i, wb_rst_i, wb_cyc_i, wb_stb_i, wb_we_i, 
    wb_adr_i, wb_dat_i, wb_dat_o, wb_ack_o, pll0_bus_i, pll0_bus_o)/* synthesis NGD_DRC_MASK=1 */;
    input wire wb_clk_i;
    input wire wb_rst_i;
    input wire wb_cyc_i;
    input wire wb_stb_i;
    ...
    EFB EFBInst_0 (.WBCLKI(wb_clk_i), .WBRSTI(wb_rst_i), .WBCYCI(wb_cyc_i), 
        ...
        .I2C1IRQO(), .I2C2IRQO(), .SPISCKO(), .SPISCKEN(), .SPIMISOO(), 
        .SPIMISOEN(), .SPIMOSIO(), .SPIMOSIEN(), .SPIMCSN7(), .SPIMCSN6(), 
        .SPIMCSN5(), .SPIMCSN4(), .SPIMCSN3(), .SPIMCSN2(), .SPIMCSN1(), 
        .SPIMCSN0(), .SPICSNEN(), .SPIIRQO(), .TCINT(), .TCOC(), .WBCUFMIRQ(), 
        .CFGWAKE(), .CFGSTDBY());

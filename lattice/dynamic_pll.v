...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n dynamic_pll -lang verilog -synth lse -arch xo3c00f -type pll -fin 12 -fclkop 48 -fclkop_tol 0.0 -fclkos 48 -fclkos_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 90 -trims_r -phase_cntl STATIC -fb_mode 1 -lock -wb  */
/* Sun Apr 11 02:49:54 2021 */


`timescale 1 ns / 1 ps
module dynamic_pll (CLKI, PLLCLK, PLLRST, PLLSTB, PLLWE, PLLDATI, 
    PLLADDR, CLKOP, CLKOS, LOCK, PLLDATO, PLLACK)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    input wire PLLCLK;
    input wire PLLRST;
    input wire PLLSTB;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATI0(PLLDATI[0]), .CLKOP(CLKOP_t), .CLKOS(CLKOS_t), .CLKOS2(), 
        .CLKOS3(), .LOCK(LOCK), .INTLOCK(), .REFCLK(), .CLKINTFB(), .DPHSRC(), 
        .PLLACK(PLLACK), .PLLDATO7(PLLDATO[7]), .PLLDATO6(PLLDATO[6]), .PLLDATO5(PLLDATO[5]), 

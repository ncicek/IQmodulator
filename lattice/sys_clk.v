...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.11_x64\ispfpga\bin\nt64\scuba.exe -w -n sys_clk -lang verilog -synth lse -arch xo3c00f -type pll -fin 12 -fclkop 72 -fclkop_tol 5.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1  */
/* Sat Feb 06 15:59:49 2021 */


`timescale 1 ns / 1 ps
module sys_clk (CLKI, CLKOP)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
